...
This should work with any UEFI bios regardless the operating system, if you have the Clover booloader put the VirtualBiosMod.efi in drivers and reboot.<br>
...
Put the new entry as first boot and as the seccond boot choose OS which want to boot after exit from VirtualBiosMod.efi app.
Please refer to [Wiki](https://github.com/serdeliuk/VirtualBiosMod/wiki) for more details.

This version modifies your bios cmos settings, you can change the bios lock and / or disable nvidia video card.
...
I hope that it will help in your future projects<br><br>
Have fun!
